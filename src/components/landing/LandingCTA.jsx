  ...
  return (
    <section className="py-20 bg-white">
      <div className="max-w-4xl mx-auto px-5">
        <div className="rounded-3xl bg-gradient-to-br from-ember-deep via-ember to-ember-glow px-8 py-14 text-center shadow-xl shadow-ember/25">
          ...
          <Button
            size="lg"
            className="mt-8 bg-white text-ember-deep hover:bg-orange-50 rounded-xl h-12 px-7 text-base"
