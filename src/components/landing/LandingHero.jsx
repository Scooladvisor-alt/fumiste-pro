  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-orange-50 via-white to-white">
      <div className="max-w-3xl mx-auto px-5 pt-24 pb-20 text-center">
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white border border-orange-100 text-ember-deep text-sm font-medium mb-7 shadow-sm">
        ...
        <h1 className="font-display font-extrabold text-4xl md:text-6xl tracking-tight text-slate-900 leading-[1.1]">
          ...
          <span className="text-ember">100% automatiques.</span>
        </h1>
        ...
        <div className="mt-9 flex flex-col sm:flex-row gap-3 justify-center">
          <Button
            size="lg"
            className="bg-ember hover:bg-ember-deep rounded-xl h-12 px-7 text-base shadow-lg shadow-ember/30"
